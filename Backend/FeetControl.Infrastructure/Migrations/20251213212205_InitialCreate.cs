        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusCompany = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverDocument_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriverDocument_Driver_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleDocument_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleDriver_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MileageAtEntry = table.Column<int>(type: "int", nullable: false),
                    MileageAtExit = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceOrder_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceOrder_Vehicle_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceOrder_Workshop_WorkshopId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceItem_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceItem_MaintenanceOrder_MaintenanceOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverDocument_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceItem_CompanyId",
                table: "MaintenanceItem",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceItem_MaintenanceOrderId",
                table: "MaintenanceItem",
                column: "MaintenanceOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceOrder_CompanyId",
                table: "MaintenanceOrder",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceOrder_VehicleId",
                table: "MaintenanceOrder",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceOrder_WorkshopId",
                table: "MaintenanceOrder",
                column: "WorkshopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleDocument_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleDriver_CompanyId",
                table: "VehicleDriver",
                column: "CompanyId");
